...
```{r}
taxa_n_i <- assignTaxonomy(seq.tab_n_i.nochim, "data/Tax_db/sh_general_release_dynamic_s_02.02.2019.fasta", multithread = TRUE, tryRC = TRUE)

saveRDS(taxa_n_i, "data/ITS/Needles/dada2/taxa.rds")
```
...
```{r}
taxa_r_i <- assignTaxonomy(seq.tab_r_i.nochim, "data/Tax_db/sh_general_release_dynamic_s_02.02.2019.fasta", multithread = TRUE, tryRC = TRUE)

saveRDS(taxa_r_i, "data/ITS/Roots/dada2/taxa.rds")
```